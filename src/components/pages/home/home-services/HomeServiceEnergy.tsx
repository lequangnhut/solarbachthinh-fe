  ...
  return (
    <div className="overflow-hidden py-10">
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-10 text-center" style={{ maxWidth: '600px' }}>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {items.map((service, index) => (
            ...
            >
              <img className="h-48 w-full object-cover" src={service.img} alt={service.title} />
              <div className="p-6">
                <div className="mb-4 flex items-center justify-center">
                  <i className={`fa ${service.icon} fa-3x text-primary`}></i>
                </div>
                <h4 className="mb-3 text-xl font-bold text-gray-800">{service.title}</h4>
